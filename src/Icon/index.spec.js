...
describe('<Icon />', () => {
  ...
  it('renders the background icon', () => {
    ...
    expect(screen.getByTestId('bzc-icon-background-icon'));
    expect(screen.queryByTestId('bzc-icon-foreground-icon')).toBe(null);
  });
  ...
  it('renders the foreground icon', () => {
    ...
    expect(screen.getByTestId('test'));
    expect(screen.getByTestId('bzc-icon-foreground-icon'));
    expect(screen.queryByTestId('bzc-icon-background-icon')).toBe(null);
  });
