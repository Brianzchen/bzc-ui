...
describe('<FormFieldContainer />', () => {
  ...
  it('renders label if passed in', () => {
    ...
    expect(screen.getByTestId('bzc-form-field-container-title').textContent).toBe(title);
  });
  ...
  it('renders the sub label if passed in', () => {
    ...
    expect(screen.getByTestId('bzc-form-field-container-sublabel').textContent).toBe(subLabel);
  });
  ...
  it('does not render optional label by default', () => {
    ...
    expect(screen.queryByTestId('bzc-form-field-container-optional-label')).toBe(null);
  });
  ...
  it('renders optional label only if optional is passed', () => {
    ...
    expect(screen.getByTestId('bzc-form-field-container-optional-label').textContent).toBe('(Optional)');
  });
