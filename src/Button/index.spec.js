...
describe('<Button />', () => {
  ...
  it('does not render focus if provider disables it', () => {
    ...
    expect(screen.queryByTestId('sf-button-focus-effect')).toBe(null);
  });

  it('renders focus element by default', () => {
    render(<Button />);

    expect(screen.queryByTestId('sf-button-focus-effect')).not.toBe(null);
  });
  ...
  it('renders prefix icon when passed', () => {
    ...
    expect(screen.getByTestId('sf-button-prefix-icon')).not.toBe(null);
  });
  ...
  it('does not render prefix icon normally', () => {
    ...
    expect(screen.queryByTestId('sf-button-prefix-icon')).toBe(null);
  });
  ...
  it('renders suffix icon wen passed', () => {
    ...
    expect(screen.getByTestId('sf-button-suffix-icon')).not.toBe(null);
  });
  ...
  it('does not render suffix icon normally', () => {
    ...
    expect(screen.queryByTestId('sf-button-suffix-icon')).toBe(null);
  });
